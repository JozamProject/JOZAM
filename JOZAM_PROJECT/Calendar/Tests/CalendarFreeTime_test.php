...
$recurringEvent_startDate = new CalendarDate ( '2015', '01', '01' );
$recurringEvent_endDate = new CalendarDate ( '2016', '01', '01' );
...
// creation & generation
$weekend_CalendarEvent = new RecurringEvent ( $weekend_startTime, $weekend_endTime, $recurringEvent_timeSlot, $weekend );
...
// creation & generation
$sleep_CalendarEvent = new RecurringEvent ( $sleep_startTime, $sleep_endTime, $recurringEvent_timeSlot );
...
// creation & generation
$lunchBreak_CalendarEvent = new RecurringEvent ( $lunchBreak_startTime, $lunchBreak_endTime, $recurringEvent_timeSlot );
...
// MORNING RECESS 
// start & end time
$morning_recessBreak_startTime = new CalendarTime ( '09', '45', '00' );
$morning_recessBreak_endTime = new CalendarTime ( '10', '15', '00' );
// creation & generation
$morning_recessBreak_CalendarEvent = new RecurringEvent ( $morning_recessBreak_startTime, $morning_recessBreak_endTime, $recurringEvent_timeSlot );
...
$morning_recessBreak_xml = $morning_recessBreak_CalendarEvent->__toXML ('morning_recessBreak');
file_put_contents ( 'RecurringEvents/Morning_recessBreak.xml', $morning_recessBreak_xml);

// AFTERNOON RECESS
// start & end time
$afternoon_recessBreak_startTime = new CalendarTime ( '15', '45', '00' );
$afternoon_recessBreak_endTime = new CalendarTime ( '16', '15', '00' );
// creation & generation
$afternoon_recessBreak_CalendarEvent = new RecurringEvent ( $afternoon_recessBreak_startTime, $afternoon_recessBreak_endTime, $recurringEvent_timeSlot );
...
$afternoon_recessBreak_xml = $afternoon_recessBreak_CalendarEvent->__toXML ('afternoon_recessBreak');
file_put_contents ( 'RecurringEvents/Afternoon_recessBreak.xml', $afternoon_recessBreak_xml);
